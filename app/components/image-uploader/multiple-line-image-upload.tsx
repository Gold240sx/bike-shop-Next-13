...
const MultipleLineImageUpload = ({ products }: any) => {
	...
	const isAddImageButtonDisabled = validImageStatuses.some((status) => !status)
				...
				{chosenProduct && (
					<div className="flex">
						...
						<div className="text-zinc-600 mr-0 ml-auto w-fit  items-end">
							...
							<SearchFilterDropdownAutoComplete data={productTitleArray} width="200px" ellipsis={true} />
						</div>
					</div>
				)}
			</div>
