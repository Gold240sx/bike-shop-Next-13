...
const MainSection = ({ history }: any) => {
	return (
		<div
			className=" main-section-container w-full relative h-[450px] bg-fixed bg-cover overflow-y-scroll flex"
			style={{
			...
			<div className="lg:flex main-section-middle z-10 ">
				<div className="flex flex-col gap-4 ms-m-description mt-5 ">
					<h2 className="font-medium text-6xl text-white">Tested and Tuned</h2>
					<p className="line-clamp-[8] w-[500px] text-zinc-400 pl-5">
						All of our products are tested and inpected by us before every shipment. We offer custom builds, rentals, and
						in-store service and support on all our products so you can hit the trails sooner.
					</p>
					<button
