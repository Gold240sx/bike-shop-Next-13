...
const navigation = [
	...
	{ name: "Products", href: "/admin/products", icon: TfiPackage, current: false },
	...
	{ name: "Documents", href: "/admin/documents", icon: DocumentDuplicateIcon, current: false },
	{ name: "Reports", href: "/admin/reports", icon: ChartPieIcon, current: false },
	{ name: "Chat", href: "/admin/chat", icon: ChatBubbleLeftRightIcon, current: false },
]
const teams = [
	{ id: 1, name: "Sales", href: "/admin/chat/sales", initial: "S", current: false },
	{ id: 2, name: "Warehouse", href: "/admin/chat/warehouse", initial: "W", current: false },
	{ id: 3, name: "Management", href: "/admin/chat/management", initial: "M", current: false },
]
...
const TailwindUISidebarLayout = ({ children }: any) => {
							...
							<Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
								...
								<div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white  px-6 pb-4">
									<div className="flex h-16 shrink-0 items-center">
										<Image className="h-8 w-auto" height={64} width={90} src={bikeShopLogo} alt="Bike Shop" />
									</div>
									...
									{navigation.map((item) => (
										<li key={item.name}>
											<Link
												...
												<item.icon
													className={classNames(
														item.current ? "text-teal-400" : "text-gray-400 group-hover:text-teal-400",
														"h-6 w-6 shrink-0"
													)}
													aria-hidden="true"
												/>
