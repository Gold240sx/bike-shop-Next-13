...
import ImageUploadSingle2 from "../single-line-image-upload"
import Image from "next/image"
import SearchFilterDropdownAutoComplete2 from "./SearchFilterDropdownAutoComplete2"
...
const MultipleLineImageUpload2 = ({ products, manufacturers }: any) => {
	...
	const reset = () => {
		...
		setValidImageStatuses([true])
		setValidColorStatuses([true])
	}
	...
	const addImage = () => {
		setImageCount(imageURLS.length + 1)
				...
				{chosenProduct && (
					<div className="flex">
						...
						<div className="text-zinc-600 mr-0 ml-auto w-fit  items-end">
							...
							<SearchFilterDropdownAutoComplete2
...
export default MultipleLineImageUpload2
